...
3. Get all of the dependencies with `sudo pacman -S rsync git xorg lxappearance-obconf-gtk3 lxterminal xorg-xrdb tint2 openbox jgmenu xwallpaper xorg-xinit thunar cantarell-fonts obconf xorg-serverm gnu-free-fonts`
...
11. Make fluorine-settings an executable with `chmod +x ~/.fluorine/gui`, and allow the backend scripts to work with `chmod +x ~/.fluorine/*.sh`.
