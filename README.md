...
3. Get all of the dependencies with `sudo pacman -S git xorg lxappearance lxterminal xorg-xrdb tint2 openbox jgmenu xwallpaper xorg-xinit thunar cantarell-fonts obconf xorg-server`
...
9. Copy the Fluorine files to your home directory with `cp -R fluorine-desktop/* ~`
10. Cleanup everything left by the setup with `rm -rf fluorine-desktop Qogir-icon-theme GTK screenshot.png LICENSE README.md`
