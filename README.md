...
3. Get all of the dependencies with `sudo pacman -S git lxappearance lxterminal xorg-xrdb tint2 openbox jgmenu xwallpaper xorg-xinit thunar cantarell-fonts obconf xorg-server`
