...
(Optional) If you'd like to edit the Openbox menu inside of Fluorine with ease, install the package `obmenu` from the AUR (should be `<AUR helper name> -S obmenu`).
