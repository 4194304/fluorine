...
3. Get all of the dependencies with `sudo pacman -S rsync git xorg lxappearance-obconf-gtk3 lxterminal xorg-xrdb tint2 openbox jgmenu xwallpaper xorg-xinit thunar cantarell-fonts obconf xorg-server gnu-free-fonts`
