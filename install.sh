...
if [[ $prompt == y* ]]; then
	cd ~
	clear
	sudo pacman -S rsync git lxappearance-obconf lxterminal xorg-xrdb tint2 openbox jgmenu xwallpaper xorg-xinit thunar cantarell-fonts 	obconf xorg-server gnu-free-fonts polkit l3afpad
